...
-- 상품당 사용자 1건 제약 제거 (한 사용자가 같은 상품에 여러 건 작성 가능)
-- Postgres 가 UNIQUE(product_id, username) 을 자동 명명한 제약명
ALTER TABLE reviews DROP CONSTRAINT IF EXISTS reviews_product_id_username_key;
